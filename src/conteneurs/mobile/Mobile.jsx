  ...
  return (
    <div className="mobile">
      ...
      <div className="mobile-contenu">
        <Link to="/inscription" className="explorer">
          Pulse dans votre poche !
        </Link>
        <h2 className="mobile-texte">Pulse dans votre poche !</h2>

        <p>
          Ayez accès à la toute nouvelle version de Pulse. Disponible sur les
          téléphones mobile pour une meilleure intégration!
        </p>
