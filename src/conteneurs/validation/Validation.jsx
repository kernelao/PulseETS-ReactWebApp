...
const Validation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (token) {
        login(token, role); // <- passe le token ET le rôle
        navigate('/app/dashboard'); // <- redirige
      } else {
        ...
        <div className='validation'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p id="uidnote" className={userFocus && user && !validName ? "instructions" : "offscreen"}>
              ...
              4 à 24 caractères. Doit commencer par une lettre. Lettres, chiffres, tirets (-) et underscores (_) autorisés.
            </p>
            ...
            <p id="emailnote" className={emailFocus && email && !validEmail ? "instructions" : "offscreen"}>
              <FontAwesomeIcon icon={faInfoCircle} /> Doit être un courriel valide.
            </p>
            ...
            <p id="pwdnote" className={pwdFocus && !validPwd ? "instructions" : "offscreen"}>
              <FontAwesomeIcon icon={faInfoCircle} /> 8 à 24 caractères. Doit inclure une majuscule, une minuscule, un chiffre et un caractère spécial.
            </p>
            ...
            <p id="confirmnote" className={matchFocus && !validMatch ? "instructions" : "offscreen"}>
              <FontAwesomeIcon icon={faInfoCircle} /> Doit correspondre au mot de passe ci-dessus.
            </p>

            <button disabled={!validName || !validEmail || !validPwd || !validMatch}>S'inscrire</button>
          </form>
