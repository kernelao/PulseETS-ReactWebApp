  ...
  return (
    <nav className={`navbar ${showLinks ? "show-navbar" : ""}`}>
      <ul className="navbar__links">
        ...
        <li className="navbar__item">
          <NavLink to="/fonctionnalites" className={({ isActive }) => isActive ? "navbar__link active" : "navbar__link"}>
            Fonctionnalités
          </NavLink>
        </li>
        <li className="navbar__item">
        ...
        <li className="navbar__item">
          <NavLink to="/faq" className={({ isActive }) => isActive ? "navbar__link active" : "navbar__link"}>
            FAQ
          </NavLink>
        </li>
        <li className="navbar__item">
        ...
        <li className="navbar__item">
          <NavLink to="/temoignages" className={({ isActive }) => isActive ? "navbar__link active" : "navbar__link"}>
            Témoignages
          </NavLink>
        </li>
        <li className="navbar__item">
